...
//кнопка дозагрузки гифок
  ...
  function getData(n){
    ...
    //если в строке поиска что-то есть, инпут это получает это
        ...
        //механизм сортировки по категориям + кнопка "more"
    if (n == 1){
      ...
      // document.getElementById(1).value = "Anime"   --- поиск без удаление значения в инпуте
    } else if (n == 2) {
      var input = "Sports";
      document.getElementById(1).value = ""
      localStorage.clear();
    ...
    //механизм поиска по категориям через localStorage
    ...
    //цикл, в каждой итерации которого обрабатывается элемент массива (гифка)
